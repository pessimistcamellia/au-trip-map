...
extra_visit = [
    ...
    (
        "wv-puffing",
        "Puffing Billy Railway（普芬比利蒸汽火车）",
        "Puffing Billy Railway, Belgrave VIC",
        11,
        1,
        "【可选】窄轨蒸汽铁路；取 Belgrave→Menzies Creek 往返（单程25分钟），含免费铁路博物馆。",
        "可选约2小时（火车往返50分钟＋博物馆约70分钟）",
        "吉朗码头驾车约107公里／约1小时45分到 Belgrave",
        "【可选】仅在 Spirit of Tasmania 07:00 准点抵港时执行；官方要求发车前60分钟到票房、09:30 硬截止。必须官网预约。10/6 中午国际航班前不可行。",
    ),
]
