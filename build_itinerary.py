...
existing_coordinates.update(
    {
        ...
        "d7-00": (-43.0035, 147.9255, "official_address"),
        "d9-04": (-41.595, 145.93, "official_address"),
...
visits = [
    ...
    (
        ...
        5,
        2,
        "当前计划入住的已订住宿；位于Sorell，连续三晚；9/29自驾Triabunna、9/30自驾Eaglehawk Neck。",
        "9月28日—10月1日连住三晚",
        "霍巴特机场约15分钟车程；Eaglehawk Neck约50分钟车程",
        "【核销】订单号5609248813｜已付AUD 340.69（2026-08-27）｜住客Zheng Chen。地址394 Arthur Highway, Sorell TAS 7172。[一键导航](https://www.google.com/maps/search/?api=1&query=Iron+Creek+Bay+Estate+394+Arthur+Highway+Sorell+TAS+7172)。Quest Savoy订单也已保留，最终取消哪一笔待决定。",
    ),
    (
        "d6-00",
    ...
    (
        "d7-00",
        "Blowhole pier（集合点）",
        "The Blowhole pier, Eaglehawk Neck TAS 7179",
        7,
        1,
        "Wild Ocean Tasmania集合点：喷水洞旁码头；预留约10分钟停车并步行下码头。",
        "07:50前到达／08:00开船",
        "从Iron Creek Bay Estate自驾约45—55公里／约50分钟",
        "【核销】订单RJ3SPTY｜集合 pier next to the Blowhole｜运营商165b Pirates Bay Drive, Eaglehawk Neck TAS 7179｜电话+61 (0) 473 770 416。[一键导航](https://www.google.com/maps/search/?api=1&query=The+Blowhole+Eaglehawk+Neck+TAS)。勿停餐车旁1小时限停位。",
    ),
    (
        "d7-01",
        "Wild Ocean Tasmania海上巡游",
        "Wild Ocean Tasmania, Eaglehawk Neck TAS",
        7,
        2,
        "2+ hour Scenic Tour：海崖、海洞、海豹与野生动物；鲸类属迁徙季机会不保证。",
        "约2小时＋（08:00出发）",
        "自驾至Blowhole pier登船",
        "【核销】订单RJ3SPTY｜原订2026-09-29 08:00，已改期为2026-09-30 08:00｜已付AUD 340.00。天气／最少4人成团；出发前一日约17:00邮件最终确认。",
    ),
    (
        "d7-03",
        "塔斯曼拱门／魔鬼厨房",
    ...
    (
        ...
        7,
        5,
        "巡游与陆上短停后自驾返回Sorell，继续入住同一房间。",
        "第3晚",
        "自驾约50分钟自Eaglehawk Neck",
        "收拾行李并确认10月1日自驾安排；晚间驾驶注意野生动物。订单5609248813。",
    ),
    (
        "d8-00",
    ...
    (
        "d9-01",
        "鸭嘴兽之家",
        "Platypus House, Wharf Flinders Street, Beauty Point TAS 7270",
        9,
        1,
        "室内／半室内环境白天稳定观察鸭嘴兽和短喙针鼹。",
        "约45分钟（10:00导览）",
        "驾车约48公里自朗塞斯顿",
        "【核销】预订号32608261295407｜2026-10-02 10:00｜2 adults｜已付AUD 59.90。地址Wharf Flinders Street, Beauty Point TAS 7270｜电话03 6383 4884。[一键导航](https://www.google.com/maps/search/?api=1&query=Platypus+House+Wharf+Flinders+Street+Beauty+Point+TAS)",
    ),
    (
        "d9-02",
        "鸽子湖",
    ...
    (
        "d9-04",
        "摇篮山恶魔保护园",
        "Devils at Cradle, 3950 Cradle Mountain Rd, Cradle Mountain TAS 7306",
        9,
        4,
        "Sunset Experience观察袋獾、东袋鼬与斑尾袋鼬；结合面部肿瘤病保育讲解。",
        "约1小时15分（19:00—20:15）",
        "自营位驾车数公里；提前10—15分钟到场",
        "【核销】预订号375091008｜Sunset Experience｜2026-10-02 19:00—20:15｜2 Adults｜已付AUD 208.80。会面3950 Cradle Mountain Rd｜电话+61 (03) 6492 1491。入场出示二维码票。[一键导航](https://www.google.com/maps/search/?api=1&query=Devils+at+Cradle+3950+Cradle+Mountain+Rd)",
    ),
    (
        "d9-05",
    ...
    places.append(
        {
            ...
            "notes": (
                "Iron Creek Bay Estate连住三晚（订单5609248813）；9/29自驾Triabunna、9/30自驾Eaglehawk Neck Blowhole。Quest Savoy订单也已保留，待最终决定取消哪一笔。"
...
data = {
    "trip": {
        ...
        "notes": "Day1(9/24)与返程境外转机点不在澳大利亚境内。9/25住Jurien Bay Tourist Park（预订号1933607）；9/26住Kalbarri Tudor（NewBook #223533）；9/28—9/30住Iron Creek Bay Estate（订单5609248813；Quest Savoy备选保留）。9/29 Maria Island Same Day Return #1441927（自驾Triabunna Wharf）；9/30 Wild Ocean Tasmania RJ3SPTY（Blowhole pier 08:00，由9/29改期）。10/1 Centennial Inn；10/2 Platypus House #32608261295407／Devils@Cradle Sunset #375091008／Discovery #J-7412711（Powered 18 Feet）；9/27宜必思快捷珀斯机场（确认号2609270502／订单1128150295267792）；10/1 Centennial确认号82424142／订单1128150872550866；10/3 Mantra确认号B3R7AJ20530／订单1128150523355170；10/4 Twelve Apostles Motel 携程1128150508438717；10/5 Brady确认号1128150503480293／订单1128150503479647。",
    },
    "places": places,
}
