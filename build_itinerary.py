...
visits = [
    ...
    (
        ...
        "选择含Hobart往返接送的产品；需另留CBD停车和步行时间。",
    ),
    (
        "d6-01",
        "塔斯曼岛海上巡游",
    ...
    (
        ...
        "提前15分钟到达",
        "从Iron Creek Bay Estate自驾约30—40分钟到霍巴特集合区域",
        "选择含Hobart—Triabunna往返接送的产品；需另留CBD停车和步行时间。",
    ),
    (
        "d7-01",
        "玛丽亚岛",
...
data = {
    "trip": {
        ...
        "notes": "Day1(9/24)与返程境外转机点不在澳大利亚境内。9/28—9/30当前计划住Iron Creek Bay Estate并自驾往返Hobart当日团集合点；Quest Savoy订单与地图点暂时保留，待最终决定取消哪一笔。10/1从Sorell经Wineglass Bay前往Centennial Inn on Bathurst；10/2住Discovery Parks – Cradle Mountain帐篷营位（已核实有位，待下单）；10/3取消塔州精神号夜航，改为延长摇篮山后从Launceston Airport搭约20:00航班飞墨尔本并住Mantra Melbourne Airport；10/4上午在墨尔本市区提车后内陆直达Twelve Apostles并住Twelve Apostles Motel & Country Retreat；10/5沿大洋路东行，经St Kilda企鹅观赏后住Brady Hotels Central Melbourne。",
    },
    "places": places,
}
