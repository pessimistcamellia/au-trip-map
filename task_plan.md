...
- [ ] 审计主路书、离线导出与地图／时间轴的地点类别呈现
- [ ] 完整删除日程页“住宿与其他信息”折叠模块及离线导出同名冗余区块
- [ ] 重新设计景点与住宿图标：景点高强调，住宿低调但仍可辨识
- [ ] 补充／更新测试并通过 typecheck、Vitest、production build
- [ ] 发布 gh-pages，使用移动端视口完成线上复验
- **状态：** in-progress
